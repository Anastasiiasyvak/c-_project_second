...
void For_saving_in_file(const std::string& Buffer) {
    std::string file_for_saving;
    std::cout << "Enter the file name for saving: ";
    std::cin >> file_for_saving;

    std::ofstream file(file_for_saving);
...
void For_loading_in_file(char* file_for_loading, char*& loaded_text) {
    ...
    while(true) {
        ...
        switch (command) {
            ...
            case 2:
                ...
                break;
            case 3:
                For_saving_in_file(Buffer);
                break;
            case 4:
                For_loading_in_file(file_for_loading, loaded_text);
                break;
            case 5:
                Print_loading_text(loaded_text);
                break;
            case 6:
                Insert_an_index(index1, index2, word_for_adding, Buffer);
                break;
            case 7:
